...
cca_ros::PlanningRequest convert_cca_ros_action_to_req(const cca_ros_msgs::msg::PlanningRequest &msg)
{
    ...
    req.task_description.affordance_info.type =
        convert_ros_screw_type_enum_to_affordance_util(msg.task_description.affordance_info.type.value);
    ...
    req.task_description.affordance_info.location_method = convert_ros_screw_location_method_enum_to_affordance_util(
    ...
    req.task_description.goal.grasp_pose =
        Eigen::MatrixXd::Map(msg.task_description.goal.grasp_pose.data(), 4, 4); // Assuming 4x4 grasp pose
    ...
    req.task_description.vir_screw_order =
        convert_ros_virtual_screw_order_enum_to_affordance_util(msg.task_description.vir_screw_order.value);

    // Convert gripper_goal_type enum
    req.task_description.gripper_goal_type =
        convert_ros_gripper_goal_type_enum_to_affordance_util(msg.task_description.gripper_goal_type.value);
...
cca_ros_msgs::msg::PlanningRequest convert_req_to_cca_ros_action(const cca_ros::PlanningRequest &req)
{
    ...
    // Convert Task Description
    msg.task_description.affordance_info.type.value =
        convert_affordance_util_screw_type_to_ros(req.task_description.affordance_info.type);
    ...
    // Convert location method enum
    msg.task_description.affordance_info.location_method.value =
        convert_affordance_util_screw_location_method_to_ros(req.task_description.affordance_info.location_method);
    ...
    msg.task_description.vir_screw_order.value =
        convert_affordance_util_virtual_screw_order_to_ros(req.task_description.vir_screw_order);

    // Convert gripper_goal_type enum
    msg.task_description.gripper_goal_type.value =
        convert_affordance_util_gripper_goal_type_to_ros(req.task_description.gripper_goal_type);
