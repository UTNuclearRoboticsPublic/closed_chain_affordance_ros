...
{
    // Analyze result
    *robot_result_status_ = this->analyze_as_result_(result.code, ex_as_names_.robot);
}
...
{
    // Analyze result
    *gripper_result_status_ = this->analyze_as_result_(result.code, ex_as_names_.gripper);
}
