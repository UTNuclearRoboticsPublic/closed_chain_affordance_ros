...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="spot_arm_moveit2_config",
    ...
    srdf_file = get_package_file("spot_arm_moveit2_config", "config/spot.srdf")
    robot_description_semantic_file = load_file(srdf_file)
    robot_description_semantic = {
        "robot_description_semantic": robot_description_semantic_file
    }

    kinematics_yaml = load_yaml("spot_arm_moveit2_config", "config/kinematics.yaml")
